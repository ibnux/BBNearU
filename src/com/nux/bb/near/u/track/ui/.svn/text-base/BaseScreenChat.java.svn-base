...
public class BaseScreenChat extends MainScreen{
	Bitmap pattern = Bitmap.getBitmapResource("pattern8-pattern-43a.png");
	VerticalFieldManager tabel = new VerticalFieldManager(VERTICAL_SCROLL);
	...
	public BaseScreenChat() {
		super(NO_HORIZONTAL_SCROLL|NO_VERTICAL_SCROLL);
		VerticalFieldManager bgField = new VerticalFieldManager(NO_VERTICAL_SCROLL|USE_ALL_WIDTH|USE_ALL_HEIGHT){
	...
	MenuItem about = new MenuItem("About",0x000200,10) {
		public void run() {
			Dialog.alert("bbnearu by ibnux.net");
		}
	};
